@if ($user->trashed() && $logged_in_user->hasAllAccess())
    ...
    @endif
@else
    @if ($logged_in_user->hasAllAccess() || in_array(current_user_role(), ['Developer', 'Super User', 'Finance Officer', 'Project Admin', 'Project Partner']))
    ...
    @if ($user->id !== $logged_in_user->id && !$user->isMasterAdmin() && $logged_in_user->hasAllAccess() || in_array(current_user_role(), ['Developer', 'Super User', 'Finance Officer', 'Project Admin', 'Project Partner']))
