            ...
            <div class="row">
                @if(!empty($project->logo) && file_exists(public_path('uploads/projects/logos/'.$project->logo)))
                    <div class="col-md-3">
                        <div class="row">
                            <div class="col">
                                <img src="{{ asset('uploads/projects/logos/'.$project->logo) }}" style="object-fit: cover;width: 100%;height: auto;" />
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col">
                        ...
                        <div class="row">
                            <div class="col">
                                @if (!empty(optional($partnerAdditionalInfo->invoiceOrganisation)->logo))
                                    <img src="{{ asset('uploads/organisations/logos/'.optional($partnerAdditionalInfo->invoiceOrganisation)->logo) }}" style="object-fit: cover;width: 100%;height: auto;" />
                                @endif
                            </div>
                        </div>
                        <div class="row mt-2">
                ...
                @if(!empty($project->funders()))
                    <div class="col-md-4">
                        <div class="row">
                            <div class="col">
                                <img src="{{ asset('uploads/organisations/logos/'.optional($project->funders()->first())->logo) }}" style="object-fit: cover;width: 100%;height: auto;" />
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col">
