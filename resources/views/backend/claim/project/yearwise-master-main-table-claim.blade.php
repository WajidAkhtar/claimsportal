        ...
        <tbody>
            ...
            <tr data-rowid="{{ ($index+1) }}">
                ...
                @for ($i = 0; $i < ceil(($project->length/4)); $i++)
                    ...
                    @endphp
                    <td>
                        <div style="{{ ($yearBudget < 0) ? 'color: red' : 'black' }};">
                            <div class="input-group-prepend">
            ...
            <tr class="light-grey-bg">
                ...
                <td class="text-center" style="{{ ($total_cost_for_each_item < 0) ? 'color: red' : 'black' }};background-color: #e9ecef;">
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text readonly">£</span>
                        </div>
                ...
                @for ($i = 0; $i < ceil(($project->length/4)); $i++)
                    <td style="{{ ($total_yearly_budget[$i] < 0) ? 'color: red' : 'black' }};background-color: #e9ecef;">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text readonly">£</span>
                            </div>
                    ...
                    <td style="{{ ($total_yearly_amount[$i] < 0) ? 'color: red' : 'black' }};background-color: #e9ecef;">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text readonly">£</span>
                            </div>
                    ...
                    <td style="{{ ($total_yearly_variance[$i] < 0) ? 'color: red' : 'black' }};background-color: #e9ecef;">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text readonly">£</span>
                            </div>
