            ...
            <tr>
                ...
                <td class="border-right">
                    <div class="input-group">
                        ...
                        {{ html()->input('number', 'yearly_data['.$yearIndex.'][claim_values]['.$costItem->id.'][variance]', (optional(optional($costItem->claims_data)->yearwise)[$yearIndex]->variance ?? 0) - $projectTotal)
                            ->placeholder('0.00')
                            ->class('form-control')
                            ->readOnly()
                            ->required() }}
