<x-forms.patch :action="route('frontend.auth.password.change')">
    <div class="form-group row">
        <label for="current_password" class="col-md-3 col-form-label text-md-left">@lang('Current Password')</label>
    ...
    <div class="form-group row">
        <label for="password" class="col-md-3 col-form-label text-md-left">@lang('New Password')</label>
    ...
    <div class="form-group row">
        <label for="password_confirmation" class="col-md-3 col-form-label text-md-left">@lang('New Password Confirmation')</label>
    ...
    <div class="form-group row mb-0">
        <div class="col-md-12 text-left">
            <button class="btn btn-sm btn-primary float-left" type="submit">@lang('Update Password')</button>
        </div>
    </div><!--form-group-->
</x-forms.patch>
