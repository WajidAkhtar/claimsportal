    ...
    <body id="main-container" class="default" style="background-color: #fff;overflow: hidden;">
        ...
        <main class="ml-0 mb-5">
            ...
            <div class="container-fluid site-width pt-5">
                <video class="login-animation" autoplay="" muted="" src="{{ asset('assets/backend/images/animation.mov') }}" loop="" id="vid" style="position: absolute;width: 100%;height: 100%;transform: rotate(270deg);left: 36%;"></video>
                <!-- START: Breadcrumbs-->
                <div class="row">
