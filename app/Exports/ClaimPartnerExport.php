...
class ClaimPartnerExport implements WithMultipleSheets
{
    use Exportable;
    ...
    {        
        ...
        $sheets[] = new ClaimPartnerMainSheet($this->project, (!empty($this->partner) ? Organisation::find($this->partner)->organisation_name : 'Mastersheet'));
        ...
        for ($yearIndex = 0; $yearIndex < ceil($this->project->length/4); $yearIndex++) {
            ...
            $sheets[] = new ClaimPartnerChildSheet($this->project, $yearIndex, $startDate, $fromDate, $globalFromDate, $remainingQuarters, $quarterNo, $currentYearQuarters, $this->partner);
