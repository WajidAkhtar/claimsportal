...
class UserController
{
    ...
    {
        $organisations = Organisation::ordered()->pluck('organisation_name', 'id');
        $preventToEditConfidentialFields = (in_array(current_user_role(), ['Administrator', 'Super User', 'Finance Officer', 'Project Admin', 'Project Partner', 'Funder']) && $user->id == auth()->user()->id);
